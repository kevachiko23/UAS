...
<head>
  ...
  <title>Data Covid-19 | Home</title>
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top" style="background-color: #222d32;">
      ...
      <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
        <span class="sr-only">Kelompok 6</span>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="../dist/img/gambar1.png" class="img-circle" alt="User">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="">
          <a href="?page=input">
            <i class="fa fa-user-plus"></i> <span>INPUT DATA</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        ...
        <!-- <li class="">
          <a href="?page=hapus">
            <i class="fa fa-trash"></i> <span>DELETE DATA</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li> -->
